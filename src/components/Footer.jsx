            ...
            <div className="flex flex-col py-20 px-5 h-max lg:items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-full lg:w-3/4 h-full gap-y-10 py-5 border-b border-white/6">
                    ...
                    <div className="flex flex-col text-white/40">
                        ...
                        <div className="flex flex-col text-sm gap-2">
                            <div className="flex items-center gap-2"><svg viewBox="0 0 20 20" style={{height:'10px',width:'10px',fill:'#2B80ED'}}><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg> <p>hello@stintus.com</p></div>
                            ...
                            <div className="flex items-center gap-2"><svg viewBox="0 0 20 20" style={{height:'10px',width:'10px',fill:'#2B80ED'}}><path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z"></path></svg> <p>Gujarat, India</p></div>
