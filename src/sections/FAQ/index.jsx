...
const FAQSection = () => {
  ...
  const faqs = [
    ["What exactly does Stinters do?","Stinters connects manufacturing plants with verified vendors for MRO, facility management, and on-demand industrial spares. You submit a requirement — we coordinate the right vendor for you."],
    ...
    ["Does Stinters cover electrical and civil work?","Absolutely. We cover single and three phase electrical work, motor repairs, welding (arc, MIG, gas), civil work like machinery foundations, metal sheet work, waterproofing, and plumbing."],
