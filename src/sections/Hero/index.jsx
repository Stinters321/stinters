        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
          ...
          <div className="relative hidden w-full max-w-lg mx-auto lg:ml-auto md:flex md:flex-col gap-3">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-white/[0.03] border border-white/[0.08] p-5 aspect-[4/3] flex items-center justify-center shadow-2xl">
              ...
              <line x1="0" y1="80" x2="480" y2="80" stroke="rgba(43,128,237,.06)" stroke-width="1"></line>
              <line x1="0" y1="160" x2="480" y2="160" stroke="rgba(43,128,237,.06)" stroke-width="1"></line>
              <line x1="0" y1="240" x2="480" y2="240" stroke="rgba(43,128,237,.06)" stroke-width="1"></line>
              <line x1="120" y1="0" x2="120" y2="320" stroke="rgba(43,128,237,.06)" stroke-width="1"></line>
              <line x1="240" y1="0" x2="240" y2="320" stroke="rgba(43,128,237,.06)" stroke-width="1"></line>
              <line x1="360" y1="0" x2="360" y2="320" stroke="rgba(43,128,237,.06)" stroke-width="1"></line>


              <g transform="translate(30,60)">
  
                <rect x="0" y="40" width="110" height="160" rx="8" fill="rgba(255,255,255,.06)" stroke="rgba(255,255,255,.12)" stroke-width="1"></rect>

                <rect x="0" y="20" width="110" height="24" rx="6" fill="rgba(43,128,237,.2)" stroke="rgba(43,128,237,.35)" stroke-width="1"></rect>
                ...
                <text x="55" y="90" font-family="Sora,sans-serif" font-size="8" fill="rgba(255,255,255,.35)" text-anchor="middle">MACHINE A</text>
                <circle cx="55" cy="130" r="28" fill="none" stroke="rgba(255,255,255,.08)" stroke-width="2"></circle>
                <circle cx="55" cy="130" r="20" fill="rgba(43,128,237,.12)" stroke="rgba(43,128,237,.25)" stroke-width="1.5"></circle>
                ...
                <g transform="translate(38,165)">
                  <rect width="34" height="22" rx="4" fill="rgba(239,68,68,.15)" stroke="rgba(239,68,68,.3)" stroke-width="1"></rect>
                  <text x="17" y="15" font-family="sans-serif" font-size="11" fill="#f87171" text-anchor="middle">⚠</text>
                </g>
              </g>

              <g transform="translate(160,180)">
                <rect x="0" y="20" width="180" height="22" rx="5" fill="rgba(255,255,255,.05)" stroke="rgba(255,255,255,.1)" stroke-width="1"></rect>
                <line x1="20" y1="20" x2="20" y2="42" stroke="rgba(255,255,255,.08)" stroke-width="1"></line>
                <line x1="50" y1="20" x2="50" y2="42" stroke="rgba(255,255,255,.08)" stroke-width="1"></line>
                <line x1="80" y1="20" x2="80" y2="42" stroke="rgba(255,255,255,.08)" stroke-width="1"></line>
                <line x1="110" y1="20" x2="110" y2="42" stroke="rgba(255,255,255,.08)" stroke-width="1"></line>
                <line x1="140" y1="20" x2="140" y2="42" stroke="rgba(255,255,255,.08)" stroke-width="1"></line>
                <line x1="165" y1="20" x2="165" y2="42" stroke="rgba(255,255,255,.08)" stroke-width="1"></line>
                <circle cx="10" cy="31" r="9" fill="rgba(255,255,255,.06)" stroke="rgba(255,255,255,.12)" stroke-width="1"></circle>
                <circle cx="170" cy="31" r="9" fill="rgba(255,255,255,.06)" stroke="rgba(255,255,255,.12)" stroke-width="1"></circle>
                <rect x="30" y="10" width="24" height="14" rx="3" fill="rgba(43,128,237,.2)" stroke="rgba(43,128,237,.3)" stroke-width="1"></rect>
                <rect x="70" y="10" width="24" height="14" rx="3" fill="rgba(43,128,237,.2)" stroke="rgba(43,128,237,.3)" stroke-width="1"></rect>
                <rect x="115" y="10" width="24" height="14" rx="3" fill="rgba(43,128,237,.15)" stroke="rgba(43,128,237,.25)" stroke-width="1"></rect>
                <text x="90" y="58" font-family="Sora,sans-serif" font-size="7" fill="rgba(255,255,255,.28)" text-anchor="middle">CONVEYOR LINE</text>
              </g>

              <g transform="translate(310,60)">
                <circle cx="40" cy="22" r="12" fill="rgba(43,128,237,.2)" stroke="rgba(43,128,237,.4)" stroke-width="1.5"></circle>
                <text x="40" y="27" font-family="sans-serif" font-size="13" text-anchor="middle" fill="#7cb8f8">👷</text>
                <rect x="32" y="36" width="16" height="30" rx="4" fill="rgba(43,128,237,.18)" stroke="rgba(43,128,237,.3)" stroke-width="1"></rect>
                <line x1="32" y1="44" x2="18" y2="60" stroke="rgba(43,128,237,.35)" stroke-width="3" stroke-linecap="round"></line>
                <line x1="48" y1="44" x2="62" y2="56" stroke="rgba(43,128,237,.35)" stroke-width="3" stroke-linecap="round"></line>
                <line x1="36" y1="66" x2="32" y2="88" stroke="rgba(43,128,237,.35)" stroke-width="3" stroke-linecap="round"></line>
                <line x1="44" y1="66" x2="48" y2="88" stroke="rgba(43,128,237,.35)" stroke-width="3" stroke-linecap="round"></line>
                ...
                <rect x="4" y="96" width="72" height="18" rx="5" fill="rgba(16,185,129,.15)" stroke="rgba(16,185,129,.3)" stroke-width="1"></rect>
                <text x="40" y="109" font-family="Sora,sans-serif" font-size="7" fill="#34d399" text-anchor="middle" font-weight="700">ON THE WAY</text>
              </g>


              <g transform="translate(380,60)">
                <rect x="0" y="0" width="80" height="100" rx="8" fill="rgba(255,255,255,.04)" stroke="rgba(255,255,255,.1)" stroke-width="1"></rect>
                <text x="40" y="16" font-family="Sora,sans-serif" font-size="7" fill="rgba(255,255,255,.35)" text-anchor="middle">SPARES</text>

                <line x1="6" y1="28" x2="74" y2="28" stroke="rgba(255,255,255,.07)" stroke-width="1"></line>
                <line x1="6" y1="56" x2="74" y2="56" stroke="rgba(255,255,255,.07)" stroke-width="1"></line>
                <line x1="6" y1="80" x2="74" y2="80" stroke="rgba(255,255,255,.07)" stroke-width="1"></line>

                <circle cx="20" cy="42" r="8" fill="rgba(43,128,237,.2)" stroke="rgba(43,128,237,.3)" stroke-width="1"></circle><circle cx="20" cy="42" r="3" fill="rgba(43,128,237,.4)"></circle>
                <rect x="34" y="34" width="14" height="14" rx="2" fill="rgba(245,158,11,.15)" stroke="rgba(245,158,11,.25)" stroke-width="1"></rect>
                <circle cx="58" cy="42" r="7" fill="rgba(16,185,129,.15)" stroke="rgba(16,185,129,.25)" stroke-width="1"></circle>
                <rect x="10" y="62" width="18" height="10" rx="2" fill="rgba(43,128,237,.15)" stroke="rgba(43,128,237,.2)" stroke-width="1"></rect>
                <circle cx="44" cy="68" r="6" fill="rgba(139,92,246,.15)" stroke="rgba(139,92,246,.25)" stroke-width="1"></circle>
                <rect x="56" y="62" width="14" height="10" rx="2" fill="rgba(245,158,11,.12)" stroke="rgba(245,158,11,.2)" stroke-width="1"></rect>

                <rect x="6" y="86" width="68" height="10" rx="3" fill="rgba(16,185,129,.1)"></rect>
                <text x="40" y="94" font-family="Sora,sans-serif" font-size="6" fill="#34d399" text-anchor="middle" font-weight="700">120 PARTS IN STOCK</text>
              </g>


              <g transform="translate(155,50)">

                <rect x="0" y="0" width="145" height="95" rx="8" fill="rgba(255,255,255,.05)" stroke="rgba(43,128,237,.2)" stroke-width="1.5"></rect>
                ...
                <text x="72" y="15" font-family="Sora,sans-serif" font-size="7.5" fill="rgba(255,255,255,.8)" text-anchor="middle" font-weight="700">LIVE RFQ DASHBOARD</text>
 
                <g transform="translate(8,30)">
                  <rect x="0" y="0" width="129" height="14" rx="3" fill="rgba(255,255,255,.04)"></rect>
                  <circle cx="6" cy="7" r="3" fill="#EF4444"></circle>
                  <text x="16" y="10" font-family="DM Sans,sans-serif" font-size="6.5" fill="rgba(255,255,255,.7)">Gearbox Repair · Line 3 · Urgent</text>
                  <rect x="102" y="2" width="27" height="10" rx="3" fill="rgba(239,68,68,.15)"></rect>
                  <text x="115" y="9" font-family="Sora,sans-serif" font-size="6" fill="#f87171" text-anchor="middle" font-weight="700">URGENT</text>
                </g>
                <g transform="translate(8,48)">
                  <rect x="0" y="0" width="129" height="14" rx="3" fill="rgba(255,255,255,.04)"></rect>
                  <circle cx="6" cy="7" r="3" fill="#2B80ED"></circle>
                  <text x="16" y="10" font-family="DM Sans,sans-serif" font-size="6.5" fill="rgba(255,255,255,.7)">PLC Troubleshooting · Mumbai</text>
                  <rect x="102" y="2" width="27" height="10" rx="3" fill="rgba(43,128,237,.18)"></rect>
                  <text x="115" y="9" font-family="Sora,sans-serif" font-size="6" fill="#7cb8f8" text-anchor="middle" font-weight="700">3 QUOTES</text>
                </g>
                <g transform="translate(8,66)">
                  <rect x="0" y="0" width="129" height="14" rx="3" fill="rgba(255,255,255,.04)"></rect>
                  <circle cx="6" cy="7" r="3" fill="#10B981"></circle>
                  <text x="16" y="10" font-family="DM Sans,sans-serif" font-size="6.5" fill="rgba(255,255,255,.7)">Custom Shaft · CNC · Ahmedabad</text>
                  <rect x="102" y="2" width="27" height="10" rx="3" fill="rgba(16,185,129,.13)"></rect>
                  <text x="115" y="9" font-family="Sora,sans-serif" font-size="6" fill="#34d399" text-anchor="middle" font-weight="700">SOURCED</text>
                </g>
              </g>

              <line x1="140" y1="155" x2="155" y2="120" stroke="rgba(43,128,237,.25)" stroke-width="1" stroke-dasharray="4,3"></line>
              <line x1="300" y1="100" x2="310" y2="100" stroke="rgba(43,128,237,.25)" stroke-width="1" stroke-dasharray="4,3"></line>
            </svg>
              </div>
            </div>
