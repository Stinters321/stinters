...
import { cardData, serviceInfo } from "./data";
  ...
  <section id="VendorSection" className="relative overflow-hidden" style={{ background: "#2B80ED", padding: "80px 0" }}>
    ...
    <div className="max-w-[1160px] mx-auto px-7 relative z-10">
      <div className="grid md:grid-cols-2 gap-14 items-center">
        ...
        <FadeUp delay={0.3} className="rounded-2xl p-5.5 backdrop-blur-sm" style={{ background: "rgba(255,255,255,.1)", border: "1px solid rgba(255,255,255,.2)", padding: 22 }}>
